...
public class login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String login = "SELECT * FROM users WHERE name = '"+jTextField1.getText()+"' AND password = '"+jPasswordField1.getText()+"'";
            Statement stmt = conn.createStatement();
            ResultSet rs = stmt.executeQuery(login);
            
            if(rs.next()){
                JOptionPane.showMessageDialog(null,"Login Successfull","Hello Mr",HEIGHT);
                clean();
                ...
                JOptionPane.showMessageDialog(null,"Incorrect Credentials Please try again","Hello!!",HEIGHT);
                clean();
            }
